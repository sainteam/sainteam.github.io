...
$result = mysqli_query($link, "SELECT * FROM Brand, Mechanism, product WHERE Brand.id_brand=product.id_brand AND Mechanism.id_mechanism=product.id_mechanism");

// while($product = mysqli_fetch_assoc($result)){

//     echo "<div><a href='single.php?id=$product[id_product]'>$product[model]</a></div>";
			...
			<div class="top-header-main">
				<div class="col-md-12 header-left">
					<div class="cart box_1">
						...
						<p><a href="javascript: document.location.href = 'index.php?clean';" class="simpleCart_empty">Очистить</a></a></p>
				...
				<div class="product-one">
					...
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							<a href="single.php?id=<?php echo $product['id_product']; ?>" class="mask"><img class="img-responsive zoom-img" src="<?php echo $product['icon']; ?>" alt="" /></a>
							<div class="product-bottom">
								<h3><?php echo $product['name']; ?> <?php echo $product['model']; ?></h3>
								<p><?php echo $product['mechanism']; ?></p>
								<h4><a class="item_add" href="index.php?update&id=<?php echo $product['id_product']; ?>"><i></i></a> <span class="item_price"><?php echo $product['price']; ?> BYN</span></h4>
							</div>
							<div class="srch">
								<span><?php echo $product['sex']; ?></span>
							</div>
						</div>
					</div>
						<?php
