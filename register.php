		...
		<div class="container">
			...
			<div class="register-main">
				<div class="col-md-6 account-left">
					<input placeholder="Имя" type="text" tabindex="1" required>
						<input placeholder="Фамилия" type="text" tabindex="2" required>
						<input placeholder="Email" type="text" tabindex="3" required>
						<input placeholder="Телефон" type="text" tabindex="3" required>
						<ul>
							<li><label class="radio left"><input type="radio" name="radio" checked=""><i></i>Мужской</label></li>
							<li><label class="radio"><input type="radio" name="radio"><i></i>Женский</label></li>
							<div class="clearfix"></div>
						</ul>
				</div>
				<div class="col-md-6 account-left">
